...
namespace ChatWithMe.Migrations
{
    ...
    [Migration("20210903071402_AddAdditionalColumnsToFriendRequestFromUserTable")]
    partial class AddAdditionalColumnsToFriendRequestFromUserTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatWithMe.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("CustomPofilePicture")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ChatWithMe.Models.Friend", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ChatWithMe.Models.Friend", b =>
                {
                    b.HasOne("ChatWithMe.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("Friends")
            ...
            modelBuilder.Entity("ChatWithMe.Models.Post", b =>
                {
                    b.HasOne("ChatWithMe.Models.ApplicationUser", "PostedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ChatWithMe.Models.ApplicationUser", null)
                        .WithMany()
